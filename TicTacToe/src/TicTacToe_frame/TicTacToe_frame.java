...
/**
 *
 * @author rachelchen0418
 */
public class TicTacToe_frame extends javax.swing.JFrame {

    private String startGame = "X";
    private int xCount = 0;
    private int oCount = 0;
    /**
     * Creates new form TicTacToe_frame
     */
    ...
    private void initComponents() {
        ...
        setTitle("Tic Tac Toe - Created by Rachel Chen");

        jPanel1.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.setLayout(new java.awt.BorderLayout());

        jLabel1.setFont(new java.awt.Font("Lucida Grande", 1, 100)); // NOI18N
        ...
        jlbPlayerX.setFont(new java.awt.Font("Lucida Grande", 1, 48)); // NOI18N
        jlbPlayerX.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlbPlayerX.setText("jLabel3");
        ...
        jlbPlayerO.setFont(new java.awt.Font("Lucida Grande", 1, 48)); // NOI18N
    ...
    private void jbtnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnExitActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame,"Do you sure you want to exit the game?","Tic Tac Toe",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicTacToe_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicTacToe_frame().setVisible(true);
            }
        });
    }
